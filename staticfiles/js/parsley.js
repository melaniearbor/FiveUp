...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    email:        "Hmm. Is that a real email address? Try again.",
    url:          "Where are you sending us?! Unicorn internet?! We need a valid url.",
    number:       "We need a valid number here. Like 10. Or 2. You get the idea.",
    integer:      "We need a valid integer here. Like 10. Or 2. You get the idea.",
    digits:       "We need digiiiits! Gimme some digits.",
    alphanum:     "Letters or numbers, pal-o. Try again."
  },
  notblank:       "Hey, give us the deets! This one can't be blank.",
  required:       "This field's required. Cough up that info, buddy.",
  pattern:        "Hmm. This one's not quite right.",
  ...
  minlength:      "Oops! Too short. It should have %s characters or more.",
  maxlength:      "Oops! This is too long. It should have %s characters or less.",
  length:         "This value length is invalid. It should be between %s and %s characters long.",
  mincheck:       "You gotta select at least %s choices.",
  maxcheck:       "You must select %s choices or less. You must!",
  check:          "You need to select between %s and %s choices. Choose! Choose!",
  equalto:        "Oops! One of these things is doing their own thing. It should be the same."
});
